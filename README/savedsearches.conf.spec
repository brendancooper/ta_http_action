...
[httpalert]
httpalert.param.endpoint = <string> Endpoint. It's a required parameter.
httpalert.param.qs_params = <string> Querystring Params.
httpalert.param.custom_headers = <string> Headers.
httpalert.param.custom_separator = <string> Used to modify what character is used to separate the key value pairs. Defaults to '='
